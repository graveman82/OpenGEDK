 ...
 * ------
 *
 * Purpose: test and sample showing how to detect GCC compiler supported.
 *
*/
#include <iostream>
#include <string>

#include "gedkCompiler.h"
...
int main()
{
    std::cout << "GEDK_GCC_VERSION: " << int(GEDK_GCC_VERSION) << std::endl;
#if !GEDK_GCC_VERSION_OR_HIGHER(8,1,1)
#   error "unsupported version of gcc compiler"
#endif
    WaitKeyAndQuit();
    return 0;
}
