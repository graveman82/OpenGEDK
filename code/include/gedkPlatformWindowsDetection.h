#ifndef OPENGEDK_PLATFORMWINDOWSDETECTION_H_INCLUDED
#define OPENGEDK_PLATFORMWINDOWSDETECTION_H_INCLUDED

/* File: gedkPlatformWindowsDetection.h
 *
 * --------
 * License
 * --------
 ...
 * ------
 *
 * Purpose: OS Windows detection tool definitions.
 *
*/
