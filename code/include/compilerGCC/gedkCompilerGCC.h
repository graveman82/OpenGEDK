#ifndef OPENGEDK_COMPILERGCC_H_INCLUDED
#define OPENGEDK_COMPILERGCC_H_INCLUDED

/* File: gedkCompilerGCC.h
 *
 * --------
 * License
 * --------
 ...
 * ------
 *
 * Purpose: gcc relative types, includes etc.
 *
*/

#include <stdint.h>

#endif // OPENGEDK_COMPILERGCC_H_INCLUDED
