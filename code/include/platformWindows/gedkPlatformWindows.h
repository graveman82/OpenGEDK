#ifndef OPENGEDK_PLATFORMWINDOWS_H_INCLUDED
#define OPENGEDK_PLATFORMWINDOWS_H_INCLUDED

/* File: gedkPlatformWindows.h
 *
 * --------
 * License
 * --------
 ...
 * ------
 *
 * Purpose: OS Windows specific definitions.
 *
*/


#endif // OPENGEDK_PLATFORMWINDOWS_H_INCLUDED
