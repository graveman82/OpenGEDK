#ifndef OPENGEDK_GCCCOMPILERDETECTION_H_INCLUDED
#define OPENGEDK_GCCCOMPILERDETECTION_H_INCLUDED

/* File: gedkCompilerGCCDetection.h
 *
 * --------
 * License
 * --------
 ...
 * ------
 *
 * Purpose: gcc compiler detection macros.
 *
*/
...
// Test for GCC >= 8.1.0
    ...
    @endcode
*/
#define GEDK_GCC_VERSION_OR_HIGHER(major,minor,patchlevel) \
    (GEDK_GCC_VERSION >= (major * 10000 + minor * 100 + patchlevel))

//-- }
//-- GCC -------------------------------------------------------------------------

#endif // OPENGEDK_GCCCOMPILERDETECTION_H_INCLUDED
