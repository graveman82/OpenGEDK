#ifndef OPENGEDK_STANDARDALLOCATIONSTRATEGY_H_INCLUDED
#define OPENGEDK_STANDARDALLOCATIONSTRATEGY_H_INCLUDED

/* File: gedkStandardAllocationStrategy.h
 *
 * --------
 * License
 * --------
 ...
 * ------
 *
 * Purpose: allocation strategy definition.
 *
 */
...
public:
	...
	static SizeType ProposeCapacity(const SizeType oldCapacity)
	{
		SizeType newCapacity = oldCapacity;
		if (oldCapacity) newCapacity += (oldCapacity >> 1);
		if(newCapacity < 4) { newCapacity = 4; }
		return newCapacity;
	}
};
} // end of gedk
#endif // OPENGEDK_STANDARDALLOCATIONSTRATEGY_H_INCLUDED
